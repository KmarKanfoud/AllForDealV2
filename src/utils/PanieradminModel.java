 ...
 * @author Toshiba
 */
public class PanieradminModel extends AbstractTableModel {

    List<Panier> lp;
    String[] colonnes ={"id", "id-User", "Username", "id-Produit", "Nom-Produit", "Nombre des produits", "Description"};

    public PanieradminModel() {
        PanierDao pdao = new PanierDao();
        lp = pdao.findAllByUser(FramePanierAdmin.getRechUser());
    }
